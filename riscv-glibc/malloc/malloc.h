...
//yh+begin
//#define DPT_QEMU
#define DPT_QUARANTINE_ENABLED
extern unsigned int DPT_H;
extern unsigned int DPT_F;

extern void (*__MALLOC_HOOK_VOLATILE __dpt_sysmalloc_hook)(void *__arena_end)
__MALLOC_DEPRECATED;
extern void (*__MALLOC_HOOK_VOLATILE __dpt_scan_bitmap_hook)(void *__ptr)
__MALLOC_DEPRECATED;
#ifdef DPT_QEMU
extern unsigned int ALLOC_NEW_ARENA;
extern void *(*__MALLOC_HOOK_VOLATILE __dpt_tagd_hook)(void *__ptr,
                                                      size_t __tweak)
__MALLOC_DEPRECATED;
extern void *(*__MALLOC_HOOK_VOLATILE __dpt_xtag_hook)(void *__ptr)
__MALLOC_DEPRECATED;
extern void (*__MALLOC_HOOK_VOLATILE __dpt_cstr_hook)(void *__ptr,
                                                      size_t __size)
__MALLOC_DEPRECATED;
extern void (*__MALLOC_HOOK_VOLATILE __dpt_cclr_hook)(void *__ptr)
__MALLOC_DEPRECATED;
#endif
...
#define QWIDTH 2
#define QDEPTH 373
static void *quarantine_buffers[QWIDTH][QDEPTH] = {0};
static int qb_widx = 0;
static int qb_didx = 0;
#endif
//yh+end
